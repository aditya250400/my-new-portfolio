...
export default function Landing(props) {
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full self-end px-4 lg:w-1/2">
                            <div className="mt-10 relative lg:mt-0 lg:right-0">
                                <img
                                    src="img/adit.png"
                                    alt="Muhamad Rizki Aditya"
                                    className="max-w-full mx-auto relative z-10"
                                />
                                <span className="absolute top-16  left-1/2 -translate-x-1/2 md:scale-125">
                                    <svg
                                        width="400"
                                        height="400"
                                        viewBox="0 0 200 200"
                                    ...
                                    >
                                        <path
                                            fill="#14b8a6"
                                            d="M39.9,-12.9C46.5,7.3,43,30.8,31.3,38.1C19.6,45.4,-0.2,36.5,-18.1,23.8C-35.9,11,-51.8,-5.5,-48.5,-21.2C-45.2,-36.9,-22.6,-51.9,-3,-50.9C16.7,-49.9,33.3,-33.1,39.9,-12.9Z"
                ...
                <div className="container">
                    <div className="flex flex-wrap">
                        <div className="w-full px-4 mb-10 lg:w-1/2">
                            ...
                            <h2 className=" font-bold text-dark text-2xl mb-5 max-w-md lg:text-4xl dark:text-white">
                                {biodata.about_title}
                            </h2>
                            <p className="font-medium text-base text-secondary max-w-xl lg:text-lg  whitespace-pre-wrap line-clamp-2 hover:line-clamp-none hover:cursor-pointer ">
                                {biodata.about_content}
                            </p>
                        </div>
                        <div className="w-full px-4 lg:w-1/2">
                            ...
                            <p className="font-medium text-base text-secondary mb-6 lg:text-lg">
                                {biodata.headline_description}
                            </p>
                            <div className="flex items-center">
                                {/* <!-- Github --> */}
                                <a
                                    href="https://github.com/aditya250400"
                                    target="_blank"
                                ...
                                {/* <!-- GitLab --> */}
                                <a
                                    href="https://gitlab.com/aditya250400"
                                    target="_blank"
                                    className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-400 text-slate-400 hover:border-primary hover:bg-primary hover:text-white"
                                >
                                    <svg
    ...
    <!-- Blog Section Start --> */}
            <section
                id="blog"
                className="pt-36 pb-32 bg-slate-200 dark:bg-dark"
            >
                <div className="container">
                    <div className="w-full px-4">
                        <div className="max-w-xl mx-auto text-center mb-16">
...
Landing.layout = (page) => <MasterLayour children={page} />;
